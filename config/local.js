...
module.exports = {
  ...
  // ssl: {
  //   ca: require('fs').readFileSync(__dirname + '/keys/gd_bundle-g2-g1.crt'),
  //   key: require('fs').readFileSync(__dirname + '/keys/instaleaf.key'),
  //   cert: require('fs').readFileSync(__dirname + '/keys/b41f80a78cc06f90.crt')
  // },
  // ssl: {
  //   ca: require('fs').readFileSync(__dirname + '/keys/domain-csr.txt'),
  //   key: require('fs').readFileSync(__dirname + '/keys/key.txt'),
  //   cert: require('fs').readFileSync(__dirname + '/keys/crt.txt')
  // },
